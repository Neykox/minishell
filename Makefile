SRCS = 	srcs/main.c \
		...
		srcs/utils/ft_notop.c srcs/utils/ft_strdup.c srcs/utils/print.c srcs/utils/ft_strlen.c  srcs/utils/ft_strncmp.c srcs/utils/ft_str_join_utils.c srcs/utils/ft_strjoin.c srcs/utils/ft_memmove.c srcs/utils/ft_split.c srcs/utils/tweaked_split.c \
